var app = {
    ...
    init: function() {
      ...
      // on lance une partie
      $('#normalMemory, #hardMemory').on('click', app.startGame);
      $('#debutantMemory').on('click', app.startGame);
    ...
    startGame: function(evt) {
      ...
      // var cliquedButton = $(evt.target).attr('id');
      // console.log(cliquedButton);
  
      if ($(evt.target).attr('id') == "normalMemory") app.normalMode = true;
  
      if ($(evt.target).attr('id') == "hardMemory") app.hardMode = true;
      ...
      $('.progressBar').animate(
        ...
        function() {
          ...
          window.alert("You lost ! You found " +app.cardMatch+ " Pairs.");
    ...
    isWin: function() {
      ...
      if (!app.normalMode && !app.hardMode && app.cardMatch == 8) {
        // Mode "débutant" + 8 paires de trouvées !
        window.alert("Great job, you won!!!");
        window.location.reload();
      }
      if (app.normalMode && app.cardMatch == 14) {
